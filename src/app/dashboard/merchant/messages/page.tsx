          ...
          <div className="flex-1 overflow-y-auto">
            {conversations.length === 0 ? (
              ...
              conversations.map((conv) => (
                ...
                >
                  <div className="h-10 w-10 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center shrink-0">
                    {conv.partner.image ? (
                      <img
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    <div className="flex items-center justify-between">
                      ...
                      {conv.unreadCount > 0 && (
                        <Badge className="bg-green-500 text-white text-[10px] h-5 min-w-5">
                          {conv.unreadCount}
                        </Badge>
                      )}
                    </div>
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-800">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500/50"
                  />
                  <Button
                    onClick={sendMessage}
                    disabled={sending || !messageInput.trim()}
                    className="bg-[#006633] hover:bg-[#006633]/90 text-white rounded-xl px-4"
                  >
                    {sending ? (
